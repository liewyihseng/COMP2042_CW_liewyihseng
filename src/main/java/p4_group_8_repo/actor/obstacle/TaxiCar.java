...
public class TaxiCar extends Obstacle implements SedanVehicle{
	 ...
	 * sets the image of the taxi car and it desired X-Coordinate and Y-Coordinate.
	 * @param xpos An integer that represents the X-Coordinate of the Taxi Car.
	 * @param ypos An integer that represents the Y-Coordinate of the Taxi Car.
	 * @param s A double representing the speed of the Taxi Car during game play.
	 */
