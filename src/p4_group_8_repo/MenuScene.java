...
public class MenuScene {
	...
	public MenuScene() {
		...
		pane.setStyle("-fx-background-image: url('file:images/Menu.png');" + "-fx-background-size: 600 800;");
		
		Button homeButton = new Button();
		ImageView homeButtonImage = new ImageView("file:images/HomeButton.png");
		...
		ImageView highScoreButtonImage = new ImageView("file:images/HighScoreButton.png");
		...
		ImageView instructionButtonImage = new ImageView("file:images/InstructionButton.png");
		...
		ImageView quitButtonImage = new ImageView("file:images/QuitButton.png");
