...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		background.add(new Log("file:images/log3test.png", 150, 0, 166, 0.75));
		background.add(new Log("file:images/log3test.png", 150, 220, 166, 0.75));
		background.add(new Log("file:images/log3test.png", 150, 440, 166, 0.75));
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 0, 166, 0.75));
		background.add(new Log("file:images/logtest.png", 300, 0, 276, -2));
		background.add(new Log("file:images/logtest.png", 300, 400, 276, -2));
		//background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 800, 276, -2));
		background.add(new Log("file:images/log3test.png", 150, 50, 329, 0.75));
		background.add(new Log("file:images/log3test.png", 150, 270, 329, 0.75));
		background.add(new Log("file:images/log3test.png", 150, 490, 329, 0.75));
		...
		//Lane1
		background.add(new Obstacle("file:images/truck2Righttest.png", 0, 649, 1, 120, 120));
		background.add(new Obstacle("file:images/truck1Righttest.png", 300, 649, 1, 120, 120));
		background.add(new Obstacle("file:images/truck1Righttest.png", 600, 649, 1, 120, 120));
		...
		//Lane2
		background.add(new Obstacle("file:images/car1Lefttest.png", 100, 597, -1, 50, 50));
		background.add(new Obstacle("file:images/car1Lefttest.png", 250, 597, -1, 50, 50));
		background.add(new Obstacle("file:images/car1Lefttest.png", 400, 597, -1, 50, 50));
		background.add(new Obstacle("file:images/car1Lefttest.png", 550, 597, -1, 50, 50));
		...
		//Lane4
		background.add(new Obstacle("file:images/car2Lefttest.png", 500, 490, -5, 50, 50));
